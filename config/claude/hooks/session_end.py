...
def main() -> None:
    ...
    try:
        ...
        structured["latest_checkpoint"] = status_payload["structuredContent"].get("latest_checkpoint")
        structured["readiness"] = status_payload["structuredContent"].get("readiness")
    except Exception as error:
        structured["warning"] = str(error)
