---
review_agents: [rabak-python-reviewer, constitution-guardian, code-simplicity-reviewer, security-sentinel, performance-oracle]
plan_review_agents: [rabak-python-reviewer, constitution-guardian, code-simplicity-reviewer]
tdd_enabled: true
tdd:
